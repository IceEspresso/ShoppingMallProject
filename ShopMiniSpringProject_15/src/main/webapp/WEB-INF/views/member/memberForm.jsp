...
<form action="memberAdd" method="get" class="memberAdd"> <!-- action을 controller주소로 변경 -->
	...
	*비밀번호:<input type="text" name="passwd" id="passwd"><br> 
	...
	전화번호:
		<div class="phone">
			...
			<input type="text" class="phone2" name="phone2" >-<input type="text" class="phone3" name="phone3" >
		</div>
	<br>
	이메일:
		<div class="email">
			<input type="text" class="email1" name="email1" >@
			<input type="text" class="email2" name="email2"  placeholder="직접입력">
			<select class="email3" >
